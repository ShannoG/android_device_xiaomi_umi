...
# Touch HAL
PRODUCT_PACKAGES += \
    vendor.lineage.touch@1.0-service.xiaomi_umi
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/wifi/wigig_supplicant_overlay.conf:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/wigig_supplicant_overlay.conf \
